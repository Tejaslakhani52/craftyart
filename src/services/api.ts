...
class ApiService {
  ...
  getUser = (props: { key: string; device_id: string; email: any }) => {
    return new Promise((resolve, reject) => {
      axios
        .post("https://story.craftyartapp.com/get/user", props)
        .then(({ data }) => {
          resolve(data);
        })
        .catch((err) => {
  ...
  getDatas = (props: {
    ...
    return new Promise((resolve, reject) => {
      axios
        .post("https://story.craftyartapp.com/get/main/data", props)
        .then(({ data }) => {
          resolve(data);
        })
        .catch((err) => reject(err));
  ...
  getCategoryDatas = (props: {
    ...
    return new Promise((resolve, reject) => {
      axios
        .post("https://story.craftyartapp.com/get/datas", props)
        .then(({ data }) => {
          resolve(data);
        })
        .catch((err) => reject(err));
  ...
  getChat = (props: { key: string; user_id: string }) => {
    return new Promise((resolve, reject) => {
      axios
        .post("https://story.craftyartapp.com/get/chat", props)
        .then(({ data }) => {
          resolve(data);
        })
        .catch((err) => reject(err));
